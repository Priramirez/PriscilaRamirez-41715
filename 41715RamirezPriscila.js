...
const dragon1 = new Dragon(0, 'Dragones Celestiales', A, 'Áragon', 180, 'imagenes/ciruelo 1.jpg');
const dragon2 = new Dragon(1, 'Dragones de magia oscura', B, 'Cynder', 1000, 'imagenes/ciruelo 6.jpg');
const dragon3 = new Dragon(2, 'Dragones Exóticos', C, 'Plutonius', 200, 'imagenes/dragon mariposa.jpg');
const dragon4 = new Dragon(3,'Dragones Guardianes', D, 'Lilith', 300, 'imagenes/ciruelo 2.jpg' );
